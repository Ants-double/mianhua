 ...
 * @date 2019/10/17
 */
public class AntsJwtUtil {

    private static final Logger logger = LoggerFactory.getLogger(AntsJwtUtil.class);
     ...
     * JWT 生成密钥使用的密码
     */
    private static final String JWT_RULE = "jwt.antsdouble";
    /**
    ...
    public static String buildJWT(SignatureAlgorithm alg, Key key, String sub, String aud, String jti, String iss, Date nbf, Integer duration) {
        ...
        String compact = Jwts.builder()
                ...
                .setIssuer(iss)
                .setNotBefore(nbf)
                .setIssuedAt(TimeConvertUtil.localDateTimeConvertDate(iat))
                .setExpiration(exp != null ? TimeConvertUtil.localDateTimeConvertDate(exp) : null)
                .compact();
